<template>
  <div id="home">
    ...
    <div id="start-shopping" class="container">
      ...
      <div class="row">
      <!--  d-flex is used to transform direct children elements into flex items   https://getbootstrap.com/docs/4.0/utilities/flex/  -->
...
export default {
  ...
  mounted(){
    // display a maximum of six categories and eight products.
