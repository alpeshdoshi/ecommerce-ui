...
export default {
  ...
  props : ["categories"],
  methods: {
    //removing api call to get categories from here as categories are already fetched in App.vue, so getting categories data from there instead of calling same api again.
   /* async getCategories() {
      //fetch categories
